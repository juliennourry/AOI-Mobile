...
public class ModelApiItem {
    ...
    public ModelApiItem(int id, String label, String onAt, String uuid, String createdAt, String deletedAt, ModelCategory fk_category, ModelSite fk_site /*, ModelTaskDone fk_mountage_step_done*/) {
        this.id = id;
        this.label = label;
        this.onAt = onAt;
        this.uuid = uuid;
    ...
    public void setCategory(ModelApiItem getCategory) { this.fk_category = fk_category; }

    public ModelSite getSite() { return fk_site; }

    public void setSite(ModelApiItem getSite) { this.fk_site = fk_site; }
